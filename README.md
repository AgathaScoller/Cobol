...
- **Programs/** – sample programs demonstrating core concepts  
- **Files/** – examples of file handling and data input/output operations  
- **Batch/** – batch processing routines and job control logic  
- **Utils/** – reusable modules and templates  
...
- Build a technical bridge between legacy environments and modern computing  

---

## ENVIRONMENT

- **Language:** COBOL (GnuCOBOL recommended)  
- **Compiler:** GnuCOBOL 3.2+  
- **Environment:** Linux or Windows with GnuCOBOL setup  
- **Editor:** VS Code with COBOL extension or any text-based IDE  
